...
keys = [Key(key[0], key[1], *key[2:]) for key in [
    ...
    #lockscreen
    ([mod, "shift"], "p", lazy.spawn("betterlockscreen -l")),

    # Window Nav
    ([mod, "shift"], "m", lazy.spawn("rofi -show")),
    ([mod, "shift"], "c", lazy.spawn("subl")),

    #install betterlockscreen for lock function

    ([mod], "m", lazy.spawn(os.path.expanduser("~/.config/rofi/launchers/type-2/launcher.sh"))),
    ([mod, "shift"], "q", lazy.spawn(os.path.expanduser("~/.config/rofi/powermenu/type-2/powermenu.sh"))),


    # Browser
    ([mod], "b", lazy.spawn("thorium-browser")),
